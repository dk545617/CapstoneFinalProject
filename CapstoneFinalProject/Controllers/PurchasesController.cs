...
namespace CapstoneFinalProject.Controllers
{
    public class PurchasesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PurchaseId,PurchaseName,Price")] Purchase purchase)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PurchaseId,PurchaseName,Price")] Purchase purchase)
        {
